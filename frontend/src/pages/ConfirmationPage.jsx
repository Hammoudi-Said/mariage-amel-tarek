          ...
          <div className="text-center">
            ...
            <div className="mb-8">
              <h3 className="text-2xl md:text-3xl font-serif text-rose-700 mb-6 flex items-center justify-center">
                ...
                <Heart className="h-8 w-8 text-rose-500 ml-3" />
              </h3>
            </div>
            
            <div className="max-w-3xl mx-auto">
              <p className="text-lg md:text-xl text-stone-700 font-serif leading-relaxed mb-6">
                Nous avons hâte de partager cette journée magique avec vous tous. Votre présence à nos côtés 
                rendra ce moment encore plus précieux et inoubliable.
              </p>
            </div>
            
            <div className="mt-8">
              <p className="text-xl md:text-2xl font-script text-amber-800" style={{fontFamily: 'Dancing Script, cursive'}}>
                Amel & Tarek
              </p>
            </div>
          </div>
